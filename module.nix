...
let
  ...
  formatTheme = theme: let
    ...
    command = if theme.yamlFile != null 
      then "${pkgs.cosmic-themes-base16}/bin/cosmic-themes-base16 ${mode} ${theme.yamlFile}"
      else "${pkgs.cosmic-themes-base16}/bin/cosmic-themes-base16 ${mode} ${
        concatStringsSep " " [
          theme.base00 theme.base01 theme.base02 theme.base03
          theme.base04 theme.base05 theme.base06 theme.base07
          theme.base08 theme.base09 theme.base0A theme.base0B
          theme.base0C theme.base0D theme.base0E theme.base0F
        ]
      }";
  in {
    inherit command;
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home.activation.generateCosmicTheme = lib.hm.dag.entryAfter ["writeBoundary"] ''
      ...
      ${let theme = formatTheme cfg.theme; in ''
